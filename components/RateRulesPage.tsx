...
const RateRulesPage: React.FC<RateRulesPageProps> = ({
  rules,
  setRules,
  onStrategySync,
}) => {
  ...
  const handleAddOverride = () => {
    ...
    const engineValue =
      formState.modifierType === "percentage"
    ...
    <div className="p-8 space-y-12 animate-in fade-in duration-700 pb-32">
      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-1">
          ...
          <h3 className="text-slate-500 font-medium max-w-xl">
            Coordinate automated price movements across your global distribution
            network.
          </h3>
        </div>
        <button
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              <div className="flex items-center gap-3">
                ...
                <span className="px-2.5 py-1 bg-slate-100 text-slate-500 text-[9px] font-black rounded-lg border border-slate-200 uppercase tracking-widest">
                  Priority: Standard
                </span>
              </div>
              <p className="text-sm text-slate-500 font-medium mt-0.5">
                Automated weekend or weekday recurring modifiers.
              </p>
            </div>
          </div>
          <button
            onClick={() =>
              setRules((prev) => ({
                ...
                weeklyRules: {
                  ...prev.weeklyRules,
                  isActive: !prev.weeklyRules.isActive,
                },
              }))
            }
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 animate-in slide-in-from-top-4 duration-500">
                    ...
                    <div className="flex items-center gap-1 bg-white border-2 border-slate-200 rounded-xl px-3 py-1.5 focus-within:border-indigo-500 focus-within:ring-4 focus-within:ring-indigo-500/10 transition-all w-32 justify-end shadow-sm">
                      ...
                      <input
                        ...
                        value={
                          rules.weeklyRules.modifierType === "percentage"
                            ? Math.round(
                                (rules.weeklyRules.modifierValue - 1) * 100,
                              )
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setRules((prev) => ({
                        ...
                        weeklyRules: {
                          ...prev.weeklyRules,
                          modifierValue: parseFloat(e.target.value),
                        },
                      }))
                    }
            ...
            <div className="bg-slate-50 rounded-[2rem] p-8 border border-slate-200/50 flex flex-col justify-center text-center">
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">
                Weekly Impact (Sample)
              </p>
              <div className="space-y-1">
                <span className="text-slate-400 text-sm line-through decoration-red-300 decoration-2">
                  ₹10,000
                </span>
      ...
      <section className="bg-white rounded-[2.5rem] p-8 border-2 border-slate-100 shadow-sm transition-all hover:border-slate-200 space-y-10">
        <div className="flex items-center gap-5">
          ...
          <div>
            <div className="flex items-center gap-3">
              ...
              <span className="px-2.5 py-1 bg-fuchsia-600 text-white text-[9px] font-black rounded-lg shadow-sm border border-fuchsia-700 uppercase tracking-widest animate-pulse">
                Critical: Active
              </span>
            </div>
            <p className="text-sm text-slate-500 font-medium mt-0.5">
              Festival blocks that automatically supersede your weekly baseline.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
            ...
            >
              <div className="flex items-center gap-8">
                <div className="flex flex-col items-center justify-center w-16 h-16 bg-white rounded-2xl shadow-sm border border-slate-100">
                  <span className="text-[10px] font-black text-slate-400 uppercase mb-1 leading-none">
                    {new Date(event.startDate).toLocaleDateString(undefined, {
                      month: "short",
                    })}
                  </span>
                  <span className="text-2xl font-black text-fuchsia-600 leading-none">
          ...
          <div className="relative p-10 bg-white border-2 border-indigo-100 rounded-[2.5rem] shadow-xl shadow-indigo-500/5 space-y-10 animate-in fade-in zoom-in-95 duration-500 mt-12 overflow-hidden">
            ...
            <div className="relative flex items-center gap-5">
              ...
              <div>
                <span className="text-[10px] font-black uppercase tracking-[0.3em] text-indigo-600 block mb-1">
                  New Policy Override
                </span>
                <h3 className="text-2xl font-black text-slate-900 tracking-tight">
                  Strategy Builder
            ...
            <div className="relative flex flex-col gap-10">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="space-y-1.5 flex-1">
                  ...
                  <div
                    className={`flex items-center gap-3 px-4 py-3.5 bg-white border-2 rounded-2xl transition-all ${formErrors.name ? "border-red-200 ring-2 ring-red-100" : "border-slate-100 focus-within:border-indigo-500"}`}
                  >
                ...
                <FormDatePicker
                  ...
                  onChange={(val) =>
                    setFormState({ ...formState, startDate: val })
                  }
                ...
                <FormDatePicker
                  ...
                  onChange={(val) =>
                    setFormState({ ...formState, endDate: val })
                  }
                ...
                <div className="space-y-1.5 flex-1">
                  ...
                  <div className="flex items-center bg-white border-2 border-slate-100 rounded-2xl transition-all focus-within:border-indigo-500 focus-within:shadow-lg focus-within:shadow-indigo-500/5 overflow-hidden">
                    <div className="relative border-r border-slate-100">
                      <select
                        ...
                        className="pl-4 pr-8 py-3.5 bg-transparent text-[11px] font-black text-indigo-600 outline-none cursor-pointer appearance-none text-center min-w-[60px]"
                      >
                        <option value="percentage">%</option>
                        <option value="fixed">₹</option>
                      </select>
                      <ChevronDown className="w-3 h-3 text-indigo-300 absolute right-2.5 top-1/2 -translate-y-1/2 pointer-events-none" />
                    </div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormState({
                          ...formState,
                          modifierValue: Number(e.target.value),
                        })
                      }
                      className="flex-1 px-4 py-3.5 bg-transparent text-sm font-black text-slate-900 outline-none"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between pt-8 border-t border-slate-100 gap-6">
                <div className="flex items-center gap-3 px-5 py-3 bg-indigo-50/50 rounded-2xl border border-indigo-100/50">
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-10 py-5 bg-indigo-600 text-white rounded-2xl font-black text-xs uppercase tracking-[0.2em] hover:bg-indigo-700 hover:shadow-2xl hover:shadow-indigo-500/40 hover:-translate-y-0.5 transition-all flex items-center justify-center gap-4 active:scale-[0.97]"
                >
        ...
        <div className="space-y-6 flex-1">
          <div>
            <h3 className="text-2xl font-black text-amber-900 tracking-tight">
              Revenue Safety Guardrails
            </h3>
            <p className="text-sm text-amber-800 font-medium leading-relaxed max-w-2xl mt-1">
              Safety guardrails act as an unbreakable ceiling and floor for all
              dynamic logic. No automation can push rates outside these defined
              zones, protecting you from pricing errors.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-[2rem] border-2 border-amber-200/40 shadow-sm group hover:border-amber-400 transition-all">
              <p className="text-[11px] font-black text-amber-500/80 uppercase tracking-widest mb-1.5">
                Unbreakable Floor (Min)
              </p>
              <div className="flex items-end gap-1.5">
                <span className="text-sm font-black text-slate-400 mb-1">
                  ₹
                </span>
        ...
        <div className="space-y-6 flex-1 z-10">
          <div>
            <h3 className="text-2xl font-black text-white tracking-tight">
              Yield Hierarchy Architecture
            </h3>
            <p className="text-sm text-slate-400 leading-relaxed font-medium mt-1">
              Hotel Sathi uses an atomic priority engine to resolve rate
              conflicts. Higher priority levels silently override lower logic
              blocks.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="bg-white/10 p-5 rounded-3xl border-2 border-emerald-500/30 shadow-sm relative overflow-hidden">
              <div className="absolute -top-1 -right-1 bg-emerald-500 text-white text-[8px] font-black px-3 py-1 rounded-bl-xl uppercase tracking-widest">
                Master
              </div>
              <div className="flex items-center gap-3 mb-3">
                <div className="w-6 h-6 rounded-full bg-emerald-500 flex items-center justify-center text-white text-[11px] font-black">
                  0
                </div>
              ...
              <p className="text-[11px] text-slate-400 leading-normal">
                Top Priority. Manual entries in the Grid bypass all automated
                logic for granular precision.
              </p>
            </div>
            <div className="bg-fuchsia-500/10 p-5 rounded-3xl border-2 border-fuchsia-500/20 shadow-sm">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-6 h-6 rounded-full bg-fuchsia-600 flex items-center justify-center text-white text-[11px] font-black">
                  1
                </div>
                <p className="text-[11px] font-black text-white uppercase tracking-widest">
                  Festival Rules
              ...
              <p className="text-[11px] text-slate-400 leading-normal">
                High Priority. Overrides weekly baseline rules for specific date
                ranges (e.g. Christmas, Diwali).
              </p>
            </div>
            <div className="bg-white/5 p-5 rounded-3xl border-2 border-white/5 shadow-sm">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-6 h-6 rounded-full bg-indigo-500 flex items-center justify-center text-white text-[11px] font-black">
                  2
                </div>
                <p className="text-[11px] font-black text-white uppercase tracking-widest">
                  Weekly Baseline
              ...
              <p className="text-[11px] text-slate-400 leading-normal">
                Normal Priority. Standard recurring modifiers for demand peaks
                like weekends.
              </p>
            </div>
          </div>

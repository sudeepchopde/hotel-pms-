      ...
      <section className="bg-white rounded-[2.5rem] p-8 border-2 border-slate-100 shadow-sm transition-all hover:border-slate-200 space-y-8">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`px-8 py-3 rounded-2xl font-bold text-xs uppercase tracking-widest transition-all shadow-xl ${rules.weeklyRules.isActive
        ...
        <div className="space-y-4">
          ...
          <div className="relative p-10 bg-white border-2 border-indigo-100 rounded-[2.5rem] shadow-xl shadow-indigo-500/5 space-y-10 animate-in fade-in zoom-in-95 duration-500 mt-12 overflow-hidden">
            ...
            <div className="relative flex items-center gap-5">
              ...
              <div>
                <span className="text-[10px] font-black uppercase tracking-[0.3em] text-indigo-600 block mb-1">New Policy Override</span>
                <h3 className="text-2xl font-black text-slate-900 tracking-tight">Strategy Builder</h3>
              </div>
            </div>
